...
const Comments = ({
  ...
  pt-4 px-10 bg-[#F8F8F8] border-b-2- lg:pb-0 pb-[100px]"
    >
      ...
      {userProfile && (
        <div
          className="absolute bottom-0 left-0 pb-6 px-2 
        md:px-10"
        >
          <form onSubmit={addComment} className="flex gap-4">
            <input
              ...
              className="bg-primary px-6 py-4 text-medium font-medium 
            border-2 width-[250px] md:w-[700px] lg:w-[350px] border-gray-100 
